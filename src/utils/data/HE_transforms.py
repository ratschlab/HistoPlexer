"""
Scripts for histology image augmentation on-the-fly by adding new class on transforms in PyTorch and torchvision.

Author: Chaoyang Yan (https://github.com/gatsby2016/Augmentation-PyTorch-Transforms/blob/master/myTransforms.py)
modified

19.04.2020 Chaoyang Yan
