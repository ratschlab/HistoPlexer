...
if __name__ == "__main__":
    ...
    parser.add_argument('--rf_path', type=str, required=False, default='/raid/sonali/project_mvs/nmi_results/final_results/cell_typing/all/rf-cell_type-raw_clip99_arc_otsu3_std_minmax_split3-r5-ntrees100-maxdepth30-ct_merged.joblib', help='Path fo the trained RF joblib file')
    ...
    if args.save_path is None:
        save_path = os.path.join(os.path.dirname(args.pred_scdata), args.data_set + '_cell_types', args.cell_types)
    else:
